	...
	<div class="form-container">
		...
		<form method="post" action="inputuser.php">
			<table class="table">
				<tr>
					<td>Username</td>
					<td><input class="form-control form-control-lg" type="text" name="username" required></td>
				</tr>
				<tr>			
					<td>Tanggal Lahir</td>
				...
				<tr>
					...
					<td><input class="form-control form-control-lg" type="date" name="tanggal_bergabung" required></td>
				</tr>
				<tr>
					<td>Alamat</td>
